...
var _initAutofocusModalInput = require("./modules/modals/init-autofocus-modal-input");
var _form = require("./modules/form-validate/form");
var _initAccordion = require("./modules/accordions/init-accordion");
var _navButtonClick = require("./modules/hero/nav-button-click");
var _initSliderHero = require("./modules/sliders/init-slider-hero");
var _initSliderPrograms = require("./modules/sliders/init-slider-programs");
var _newsButtonСlick = require("./modules/news/news-button-\u0441lick");
var _initSliderNews = require("./modules/sliders/init-slider-news");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initAutofocusModalInput.initAutofocusModalInput)();
    var form = new _form.Form();
    window.form = form;
    form.init();
    (0, _initAccordion.initAccordions)();
    (0, _navButtonClick.navButtonClick)();
    (0, _initSliderHero.initSliderHero)();
    (0, _initSliderPrograms.initSliderPrograms)();
    (0, _initSliderNews.initSliderControlsNews)();
    (0, _initSliderNews.initSliderNews)();
    (0, _initSliderNews.initSliderControllerNews)();
    (0, _newsButtonСlick.newsButtonClick)();
...
},{"./modules/accordions/init-accordion":3,"./modules/form-validate/form":5,"./modules/hero/nav-button-click":11,"./modules/map/map":12,"./modules/modals/init-autofocus-modal-input":13,"./modules/modals/init-modals":14,"./modules/news/news-button-сlick":16,"./modules/select/custom-select":18,"./modules/sliders/init-slider-hero":20,"./modules/sliders/init-slider-news":21,"./modules/sliders/init-slider-programs":22,"./modules/sliders/init-slider-reviews":23,"./utils/ios-vh-fix":26}],2:[function(require,module,exports){
"use strict";
...
exports.navButtonClick = void 0;
var overlay = document.querySelector('.overlay');
var body = document.querySelector('body');
var nav = document.querySelector('.main-nav');
var navButton = document.querySelector('.main-nav__toggle');
var programsList = document.querySelector('.site-list__button--programs');
var newsList = document.querySelector('.site-list__button--news');
var programsButton = document.querySelector('.site-list__toggle--programs');
var newsButton = document.querySelector('.site-list__toggle--news');
var navLink = document.querySelectorAll('.site-list__link');
var navLinkSecondary = document.querySelectorAll('.site-list__link-secondary');
var navButtonClick = function navButtonClick() {
  ...
  navLinkSecondary.forEach(function (item) {
    item.addEventListener('click', function () {
      closeMenu();
    });
  });
};
exports.navButtonClick = navButtonClick;
...
var map = function map() {
  var map = L.map('map').setView([55.0285, 82.9282], 13);
...
exports.initAutofocusModalInput = void 0;
var initAutofocusModalInput = function initAutofocusModalInput() {
  if (window.innerWidth > 767) {
    var btn = document.querySelector('.about__btn');
    var input = document.getElementById('name-field-modal');
...
exports.initAutofocusModalInput = initAutofocusModalInput;
...
},{"../../utils/focus-lock":24,"../../utils/scroll-lock":27}],16:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.newsButtonClick = void 0;
var buttonGeneral = document.querySelector('.news__general');
var buttonVolunteer = document.querySelector('.news__volunteer');
var buttonInternships = document.querySelector('.news__internships');
var buttonCareer = document.querySelector('.news__career');
var buttonTrips = document.querySelector('.news__trips');
var listVolunteer = document.getElementById('volunteer');
var listInternships = document.getElementById('internships');
var listCareer = document.getElementById('career');
var listTrips = document.getElementById('trips');
var newsButtonClick = function newsButtonClick() {
...
exports.newsButtonClick = newsButtonClick;
...
},{"./create-select-markup":17,"./utils":19}],19:[function(require,module,exports){
"use strict";
...
exports.initSliderHero = void 0;
var sliderHero = document.querySelector('.hero__swiper');
...
exports.initSliderNews = exports.initSliderControlsNews = exports.initSliderControllerNews = void 0;
var sliderNews = document.querySelector('.news__swiper');
var newsPagination = document.querySelector('.news__pagination');
var buttonPrev = document.querySelector('.news__button--prev');
var buttonNext = document.querySelector('.news__button--next');
var sliderNewsCards;
...
var sliderControls = document.querySelector('.news__controls-swiper');
var sliderControlsWrapper = document.querySelector('.news__controls');
var sliderControlsSlide = document.querySelectorAll('.news__control');
var sliderNewsControls;
var initSliderControlsNews = function initSliderControlsNews() {
  if (window.innerWidth < 768) {
    ...
    sliderControlsSlide.forEach(function (item) {
      item.classList.remove('swiper-slide');
    });
  }
};
exports.initSliderControlsNews = initSliderControlsNews;
var initSliderControllerNews = function initSliderControllerNews() {
  if (window.innerWidth < 768) {
    sliderNewsControls.controller.control = sliderNewsCards;
    sliderNewsCards.controller.control = sliderNewsControls;
  }
};
exports.initSliderControllerNews = initSliderControllerNews;
...
exports.initSliderPrograms = void 0;
var sliderPrograms = document.querySelector('.programs__swiper');
var buttonPrev = document.querySelector('.programs__button--prev');
var buttonNext = document.querySelector('.programs__button--next');
var programsPagination = document.querySelector('.programs__pagination');
var initSliderPrograms = function initSliderPrograms() {
  if (sliderPrograms) {
    // eslint-disable-next-line
...
exports.initSliderPrograms = initSliderPrograms;
...
var reviewsPagination = document.querySelector('.reviews__pagination');
...
},{"./ios-checker":25}],27:[function(require,module,exports){
"use strict";
