...
const build = gulp.series(clean, copy, sprite, createWebp, gulp.parallel(compileMinStyles, compileMainMinScripts, compileVendorScripts, optimizePng, optimizeJpg, optimizeSvg));
...
const start = gulp.series(clean, copy, sprite, createWebp, gulp.parallel(compileStyles, compileMainScripts, compileVendorScripts), syncServer);
